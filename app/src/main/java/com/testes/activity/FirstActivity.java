...
public class FirstActivity extends AppCompatActivity implements ActionMode.Callback, NavigationDrawerCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivityButton = findViewById(R.id.mainButton);
        imageView = findViewById(R.id.imageViewFirst);
        scrollViewLayout = findViewById(R.id.scrollViewLayout);
        drawerButton = findViewById(R.id.fullImage);
        textAnimationButton = findViewById(R.id.textAnimationButton);
        ...
        drawerRelativeLayout = findViewById(R.id.drawer_layout);
        createTemFiles = findViewById(R.id.createTempFilesButton);
